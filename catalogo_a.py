...
class Ventana_p:
    def __init__(self, root):
        ...
        self.root.title("CATÁLOGO DIGITAL LOCURA")
    ...
    def circulo_carga(self, ancho,alto):
        ...
        def iniciar_descarga():
            ...
            lab = tk.Label(self.popup, text="Espere unos segundos por favor mientras se verifica si hay actualizaciones", font=("SEGOE UI", self.letra+10, "bold"), fg="#04366D", bg="white")
