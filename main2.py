...
class Ventana_p:
    def __init__(self, root):
        ...
        self.back =   CTkImage(Image.open("Catalogo_digital-main/back.png"), size=(back[0], back[1]))
    ...
    def empresa(self):
        ...
        imagenn = CTkImage(Image.open("Catalogo_digital-main/Empresa2.png"), size=(650, 325))
    ...
    def crear_tabla(self, dataframe):
            ...
            def aplicar_imagen(cod):
                ...
                try:
                    ...
                    imagen_tk = CTkImage(Image.open(f"Catalogo_digital-main/fotos/{cod}.jpg"), size=(ancho, alto))
                    ...
                    ancho = self.frame_img.winfo_width()
                    alto = self.frame_img.winfo_height()
                    imagen_tk = CTkImage(Image.open("Catalogo_digital-main/nofile.png"), size=(ancho, alto))
    ...
    def interfaz_buscador(self, df):
        ...
        def mostrar_foto_grande():
            ...
            button = ctk.CTkButton(top, text="Descargar imagen",font=("SEGOE UI", self.letra, "bold"), cursor= "hand2", fg_color="#032956", text_color="white", hover_color="gray60", command=lambda ruta = f"Catalogo_digital-main/fotos/{value_1}.jpg", nombre = value_1: guardar_imagen(ruta,nombre),corner_radius=50)
        ...
        self.lab = ctk.CTkButton(self.frame_img, fg_color="white",cursor= "hand2",command=mostrar_foto_grande, text="", hover_color="white",corner_radius=50)
        ...
        self.segementar_lineas = ctk.CTkSegmentedButton(self.frame_filtros, values=[ "TODAS", "LIVIANA", "PESADA", "OTROS MERCADOS"], bg_color="#ededed", fg_color="gray70", text_color="white", selected_color="#04366D", font=("SEGOE UI", self.letra+2, "bold"), unselected_color="gray80", unselected_hover_color="#04366D", command=segment,border_width=3, selected_hover_color="#04366D", variable= self.var)
        self.segementar_lineas.place(relx= 0.5, rely= 0.6, anchor="center", relheight = 0.45, relwidth=0.25)
        ...
        self.entry_buscar2 = ctk.CTkEntry(self.frame_filtros, width= 200,font=("SEGOE UI", self.diez+2, "bold"),  text_color="gray80")
        self.entry_buscar2.place(relx= 0.68, rely= 0.6, anchor="center", relwidth= 0.1, relheight = 0.45)
        self.entry_buscar2.insert(0, "Buscar...")
    ...
    def frame_principal_fn(self):
        ...
        def insertar_imagen(event):
            try:   
                ...
                image = Image.open(f"Catalogo_digital-main/banner.png").resize((ancho,alto), Image.BILINEAR)       
