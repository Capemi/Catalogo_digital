...
class Ventana_p:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("CATÁLOGO DIGITAL - CAPEMI Kkkk")
    ...
    def probar_new_main(self):
        ...
        def ejecutar(): 
            try:
                ...
                if os.path.isfile(f"{self.ruta_foto}/main2.py"):
                    ...
                    if g == "Si":
                        import shutil
                        shutil.abrir_ventana_nueva(self.nombre_archivo_principal, self.ruta_foto)
                        sys.exit()
    ...
    def crear_tabla(self, dataframe):
            ...
            def aplicar_imagen(cod):
                ...
                try:
                    ...
                    imagen_tk = CTkImage(Image.open(f"{self.ruta_foto}/{cod}.jpg"), size=(ancho, alto))
