...
class Ventana_p:
    def __init__(self, root):
        ...
        self.root.geometry(f"{ancho_ventana}x{alto_ventana-70}+{x}+{y}")
        ...
        def enter_botones(event):
            if event.widget.cget("text") =="|" or event.widget.cget("text") =="Verificar actualizaciones": 
                ...
                event.widget.configure(font=("SEGOE UI",  self.letra+11, "bold"))
                event.widget.configure(foreground='dodgerblue3')

            if event.widget.cget("text") == "Lanzamientos":
                boton2.config(font=("SEGOE UI",  self.letra, "bold"))
                boton3.config(font=("SEGOE UI",  self.letra, "bold"))
            elif event.widget.cget("text") == "Contacto":
                
                boton1.config(font=("SEGOE UI",  self.letra, "bold"))
                boton3.config(font=("SEGOE UI",  self.letra, "bold"))
            elif event.widget.cget("text") == "Empresa":
                boton2.config(font=("SEGOE UI",  self.letra, "bold"))
                boton1.config(font=("SEGOE UI",  self.letra, "bold"))
            elif event.widget.cget("text") =="|":
                boton3.config(font=("SEGOE UI",  self.letra+11, "bold"), foreground='dodgerblue3')
                boton2.config(font=("SEGOE UI",  self.letra, "bold"))
                boton1.config(font=("SEGOE UI",  self.letra, "bold"))
        ...
        def salir_botones(event):
            barra1.config(font=("SEGOE UI",  self.letra+20, "bold"))
            barra2.config(font=("SEGOE UI",  self.letra+20, "bold"))
        ...
        boton2 = tk.Button(self.frame_botones, text = "Contacto" ,fg="#04366D", borderwidth=0, highlightthickness=0, cursor="hand2",font=("SEGOE UI",  self.letra+3, "bold"), bg= "#ededed", anchor="center",justify="center", command =self.contacto, activebackground="#ededed", activeforeground= "dodgerblue3")
        boton2.bind("<Enter>",enter_botones)
        boton2.bind("<Leave>", salir_botones)
        boton3 = tk.Button(self.frame_botones, text = "Empresa" ,fg="#04366D", borderwidth=0, highlightthickness=0, cursor="hand2",font=("SEGOE UI",  self.letra+3, "bold"), bg= "#ededed", anchor="center",justify="center", command=self.empresa, activebackground="#ededed", activeforeground= "dodgerblue3")
