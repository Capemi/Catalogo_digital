...
def conectar_bd():
    con = sqlite3.connect(f'catalogo_digital-main/Articuloss.db')
    return con
...
class Ventana_p:
    def __init__(self, root):
        ...
        self.ruta_foto = os.path.join('catalogo_digital-main/fotos')
    ...
    def verificar_si_actualizacion(self):
        ...
        if diferencia_db.total_seconds() < 0:           
            ...
            self.popup.destroy()
            ruta_del_archivo = "Catalogo_digital-main/fotos/dist/build/archivos/copias/dir/catalogo_a.py" 
    ...
    def table_inf(self, *event):
            ...
            self.tabla_inf.edit_row(0 ,text_color="white", font=("SEGOE UI", self.letra+3, "bold"))
    ...
    def frame_principal_fn(self):
        ...
        lab = tk.Button(self.frame_publicidad, background= "#ededed", highlightbackground="#ededed", cursor="hand2", highlightcolor="#ededed", highlightthickness=0, borderwidth=0, border=0)
        ...
        lab.bind("<Button-1>", abrir_enlace)
